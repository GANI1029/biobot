...
from cards import generate_start_poll_card, bio_start_poll_card, reply, card_all ,all_choices
...
def create_poll(command,roomId, sender):
    if command == "bio metric":
        ...
        teams_api.messages.create(toPersonEmail=sender, text="Cards Unsupported",attachments=[all_choices(roomId)])
